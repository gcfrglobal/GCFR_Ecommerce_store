      ...
      <div className={`${currentSlide} transition-all duration-1000 flex w-[4490px]`}>
        {sliderContent.map((item) => {
          ...
          <div key={item.name} className={`flex relative transition-all duration-1000`}>
            <img alt="itemImage" src={item.image} className="w-[2000px] h-[550px] object-cover lg:object-top object-top sm:object-top bg-cover flex flex-row" />
            ...
            <div className="flex flex-col lg:justify-between items-start sm:justify-between text-left w-full absolute text-white top-1/3 ltr:left-10 rtl:right-10 px-0 lg:px-4 lg:-mt-20 sm:-mt-40">
              ...
              <div className='flex flex-row justify-between items-center w-full lg:px-0 px-0 absolute lg:mt-36 sm:mt-[100px]'>
                <div className='prevSlide absolute left-0 bg-white px-2 py-3 rounded-full text-black flex items-center'>
                  <button onClick={handlePrevSlide}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="lg:w-8 lg:h-6 sm:w-6 sm:h-12 cursor-pointer"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" /></svg></button>
                </div>
                <div className='nextSlide absolute right-28 bg-white px-2 py-3 rounded-full text-black flex items-center'>
                  <button onClick={handleNextSlide}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="lg:w-8 lg:h-6 sm:w-6 sm:h-12 cursor-pointer"><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg></button>
                </div>
              </div>
